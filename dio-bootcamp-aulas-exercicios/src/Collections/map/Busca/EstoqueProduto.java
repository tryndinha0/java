...
public class EstoqueProduto {
    ...
    public Produto obterProdutoMaiorQuantidadeValorTotalNoEstoque() {
        ...
        if (!estoqueProdutosMap.isEmpty()) {
            ...
            for (Produto p : estoqueProdutosMap.values()) { // Percorre para encontrar o primeiro produto válido
                produtoMaisQuantidade = p;
                soma = p.getPreco() * p.getQuantidade();
                break; // Sai do loop após pegar o primeiro produto
            }
            for (Produto p : estoqueProdutosMap.values()) {
                soma = p.getPreco() * p.getQuantidade();
                if (soma > (produtoMaisQuantidade.getPreco() * produtoMaisQuantidade.getQuantidade())) {
                    produtoMaisQuantidade = p;
                }
            }
        }
